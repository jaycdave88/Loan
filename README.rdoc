====Url:
https://roostify-jay.herokuapp.com

---
== README

Web application that will create a .pdf with the provided information from the user.

====User Stories
- A user can sign in / if previously signed up
- A user can sign up 
- A user can logout 
...
- Down payment, 
- Interest rate
(hits submit should create a new .pdf )
---
====PDF Example:
- Loan name:
- Loan amount:
...
- Notes: 
---
====Rails 4.2 gems to use:
- Login -> devise 
- File up loader -> paperclip 
- .pdf -> prawn 
- Database -> postgres
- CSS -> bootstrap 3.2
